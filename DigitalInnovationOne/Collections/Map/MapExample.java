package DigitalInnovationOne.Collections.Map;
...
public class MapExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Exiba os consumos dos modelos");
        ...
        for (Map.Entry<String, Double> entry : entries){
            if (entry.getValue().equals(maisEconomico)) {
                ...
                System.out.println("Modelo mais eficiente: " + modeloMaisEficiente + " - " + maisEconomico);
            }
        }
        System.out.println();
        ...
        System.out.println("Exiba todos os carros na ordem em que foram informadas");
